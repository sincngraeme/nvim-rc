...
--
-- -- vim.fn.sign_define('DapBreakpoint', {text=' ', texthl='', linehl='CursorLine', numhl='Error'})
-- -- vim.fn.sign_define('DapBreakpointCondition', {text=' ', texthl='', linehl='CursorLine', numhl='Error'})
-- -- vim.fn.sign_define('DapLogPoint', {text=' ', texthl='', linehl='CursorLine', numhl='Info'})
-- -- vim.fn.sign_define('DapStopped', {text=' ', texthl='', linehl='CursorLine', numhl='Info'})
-- vim.fn.sign_define('DapBreakpoint', {text='', texthl='', linehl='CursorLine', numhl='Error'})
-- vim.fn.sign_define('DapBreakpointCondition', {text='', texthl='', linehl='CursorLine', numhl='Warning'})
-- vim.fn.sign_define('DapLogPoint', {text='', texthl='', linehl='CursorLine', numhl='Info'})
-- vim.fn.sign_define('DapBreakpointRejected', {text='R', texthl='', linehl='CursorLine', numhl='Error'})
-- vim.fn.sign_define('DapStopped', {text=' ', texthl='', linehl='CursorLine', numhl='Info'})
--
